...
const cacheName = 'FinalLearningActivty5Katelyn-2021-03-03 19:45:53.985600'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'FinalLearningActivty5Katelyn'.length) === 'FinalLearningActivty5Katelyn') {
